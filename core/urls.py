...
urlpatterns = [
    ...
    path('country/get/', views.LocationViewSet.as_view({'get': 'list'})),
    path('country/create/', views.LocationViewSet.as_view({'post': 'create'})),
    path('country/update/<slug:pk>/', views.LocationViewSet.as_view({'post': 'update'})),
    path('country/delete/<slug:pk>/', views.LocationViewSet.as_view({'post': 'destroy'})),
